...
class ConjunctionSet():
    def __init__(self,feature_names,original_data, pruning_x, pruning_y,
        ...
        self.relevant_indexes = new_pruning(self.model,pruning_x,pruning_y,minimal_forest_size)
        #self.relevant_indexes = DISC_pruning(self.model,pruning_x,pruning_y,minimal_forest_size)
